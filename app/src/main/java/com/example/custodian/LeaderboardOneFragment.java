 ...
 * Use the {@link LeaderboardOneFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class LeaderboardOneFragment extends Fragment {
     ...
     * @return A new instance of fragment LeaderboardOneFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static LeaderboardOneFragment newInstance(String param1, String param2) {
        LeaderboardOneFragment fragment = new LeaderboardOneFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_leaderboard_one, container, false);

        mIcon = view.findViewById(R.id.ivLeaderboardOneIcon);
        mUsernameText = view.findViewById(R.id.tvLeaderboardOneUsername);
        mPointsText = view.findViewById(R.id.tvLeaderboardOnePoints);
        ...
        FirebaseFirestore.getInstance().collection("users").orderBy("alltimepoints", Query.Direction.DESCENDING).limit(3).get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                ...
                mUsernameText.setText(usernameArray.get(0));
                mPointsText.setText(pointArray.get(0).toString() + "pts");
